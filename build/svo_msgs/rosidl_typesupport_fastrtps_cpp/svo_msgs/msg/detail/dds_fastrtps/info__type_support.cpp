...
#include "svo_msgs/msg/detail/info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const svo_msgs::msg::Info & ros_message,
  ...
  size_t current_alignment)
{
  ...
  // Member: keyframes
  {
    ...
    size_t item_size = sizeof(ros_message.keyframes[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svo_msgs::msg::Info;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const svo_msgs::msg::Info *>(
    untyped_ros_message);
...
{
  return &svo_msgs::msg::typesupport_fastrtps_cpp::_Info__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, svo_msgs, msg, Info)() {
  return &svo_msgs::msg::typesupport_fastrtps_cpp::_Info__handle;
}
