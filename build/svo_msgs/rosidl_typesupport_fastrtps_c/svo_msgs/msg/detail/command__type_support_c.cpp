...
#include "svo_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // bodyrates
...
using _Command__ros_msg_type = svo_msgs__msg__Command;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: is_single_rotor_thrust
  {
  ...
  {
    size_t size = 4;
    auto array_ptr = ros_message->thrusts;
...
size_t get_serialized_size_svo_msgs__msg__Command(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Command__ros_msg_type * ros_message = static_cast<const _Command__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_svo_msgs__msg__Command(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_svo_msgs
size_t max_serialized_size_svo_msgs__msg__Command(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svo_msgs__msg__Command;
    is_plain =
      (
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_svo_msgs__msg__Command(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, svo_msgs, msg, Command)() {
