...
public:
  ...
  bool correct_scale_and_axis_misalignment = false;
  Eigen::Matrix3d Mg = Eigen::Matrix3d::Identity();
  Eigen::Matrix3d Mg_inv = Eigen::Matrix3d::Identity();
  Eigen::Matrix3d Ma = Eigen::Matrix3d::Identity();
  Eigen::Matrix3d Ma_inv = Eigen::Matrix3d::Identity();
  ...
  inline void print(const std::string& s = "IMU Calibration: ") const
  {
    std::cout << s << std::endl
              ...
              << "  correct_scale_and_axis_misalignment = " << correct_scale_and_axis_misalignment << std::endl
