...
bool svo_msgs__msg__dense_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("svo_msgs.msg._dense_input.DenseInput", full_classname_dest, 36) == 0);
  }
  svo_msgs__msg__DenseInput * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DenseInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("svo_msgs.msg._dense_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DenseInput");
