...
bool svo_msgs__msg__feature__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("svo_msgs.msg._feature.Feature", full_classname_dest, 29) == 0);
  }
  svo_msgs__msg__Feature * ros_message = _ros_message;
  {  // x
...
PyObject * svo_msgs__msg__feature__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("svo_msgs.msg._feature");
