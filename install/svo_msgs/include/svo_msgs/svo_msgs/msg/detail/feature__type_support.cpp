...
{
  new (message_memory) svo_msgs::msg::Feature(_init);
}

void Feature_fini_function(void * message_memory)
{
  auto typed_message = static_cast<svo_msgs::msg::Feature *>(message_memory);
  typed_message->~Feature();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Feature_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(svo_msgs::msg::Feature, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(svo_msgs::msg::Feature, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(svo_msgs::msg::Feature, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::svo_msgs::msg::rosidl_typesupport_introspection_cpp::Feature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, svo_msgs, msg, Feature)() {
  return &::svo_msgs::msg::rosidl_typesupport_introspection_cpp::Feature_message_type_support_handle;
}
