...
bool svo_msgs__msg__nbv_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("svo_msgs.msg._nbv_trajectory.NbvTrajectory", full_classname_dest, 42) == 0);
  }
  svo_msgs__msg__NbvTrajectory * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of NbvTrajectory */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("svo_msgs.msg._nbv_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NbvTrajectory");
