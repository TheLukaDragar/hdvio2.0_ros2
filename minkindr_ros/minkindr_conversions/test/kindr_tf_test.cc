...
TEST(KindrTfTest, transformPointKindrToTf) {
  ...
  tf2::transformKindrToTF(kindr_transform, &tf_transform);

  Eigen::Vector3d kindr_point(Eigen::Vector3d::Random());
  tf2::Vector3 tf_point;

  tf2::vectorKindrToTF(kindr_point, &tf_point);
...
TEST(KindrTfTest, transformKindrToTFToKindr) {
  ...
  tf2::transformTFToKindr(tf_transform, &output_transform);
...
TEST(KindrTfTest, quaternionKindrToTFToKindr) {
  ...
  tf2::quaternionKindrToTF(rotation, &tf_quaternion);
  Eigen::Quaterniond output_rotation;
  tf2::quaternionTFToKindr(tf_quaternion, &output_rotation);
...
TEST(KindrTfTest, vectorKindrToTFToKindr) {
  ...
  tf2::vectorKindrToTF(position, &tf_vector);
  Eigen::Vector3d output_position;
  tf2::vectorTFToKindr(tf_vector, &output_position);
