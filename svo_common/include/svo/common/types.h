...
struct PoseMeasurement
{
  ...
  PoseMeasurement(){}
  ~PoseMeasurement(){}
  PoseMeasurement(const double timestamp, const Transformation& T):
  timestamp_(timestamp), T_(T){}
};

typedef std::vector<PoseMeasurement, 
Eigen::aligned_allocator<PoseMeasurement>> PoseMeasurements;
