...
static const _Info_type_support_symbol_names_t _Info_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, svo_msgs, msg, Info)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, svo_msgs, msg, Info)),
  }
};
...
{
  return &::svo_msgs::msg::rosidl_typesupport_cpp::Info_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, svo_msgs, msg, Info)() {
  return get_message_type_support_handle<svo_msgs::msg::Info>();
}
